...
class _TransferWidgetState extends State<TransferWidget> {
  ...
  List<Map<String, dynamic>> transactions = [
    {'token': null, 'recipient': '', 'amount': '', 'recipientError': '', 'amountError': ''}
  ];
  ...
  bool isValidAmount(String value, Token token) {
    ...
    try {
      ...
      double tokenValue = double.parse(tokenValueStr) / pow(10, token.decimals!);
  ...
  void addTransaction() {
    setState(() {
      transactions.add({'token': null, 'recipient': '', 'amount': '', 'recipientError': '', 'amountError': ''});
  ...
  Widget build(BuildContext context) {
    return Padding(
      padding:EdgeInsets.only(left: widget.stage==1? 50.0:0),  // Offset padding for alignment
      child: SizedBox(
        ...
        widget.stage==-1?
         Center(child: Column(
          ...
          children: const [
            Text("Awaiting confirmation...", style: TextStyle(fontSize: 20),),
            SizedBox(height: 200),
  ...
  Widget buildTransactionSet() {
    return   Stack(
          children: [
            ...
            Positioned.fill(
              child: Padding(
                padding: const EdgeInsets.only(bottom: 80), // Prevent scroll overlap with Submit button
                child: Scrollbar(
                  controller: _scrollController,  // Attach the ScrollController to the Scrollbar
                  child: SingleChildScrollView(
                    controller: _scrollController,  // Attach the same ScrollController to the ScrollView
                    child: Column(
                      ...
                      children: [
                            ...
                            return Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                      ...
                                      children: [
                                        ...
                                        SizedBox(
                                          ...
                                          child: DropdownButtonFormField<Token>(
                                            ...
                                            onChanged: (value) {
                                              setState(() {
                                                transactions[index]['token'] = value!;
                                              });
                                              validateTransactions(); // Revalidate on token change
                                            },
                                            items: widget.treasury.keys.map((Token token) {
                                        ...
                                        SizedBox(
                                          ...
                                          child: TextField(
                                            onChanged: (value) {
                                              setState(() {
                                                transactions[index]['recipient'] = value;
                                            ...
                                            decoration: InputDecoration(
                                              ...
                                              errorText: transactions[index]['recipientError'].isNotEmpty
                                                  ? transactions[index]['recipientError']
                                                  : null,
                                            ),
                                          ),
                                        ),
                                          ...
                                          child: TextField(
                                            onChanged: (value) {
                                              setState(() {
                                                ...
                                                validateTransactions(); 
                                                widget.p.value=double.parse(value);
                                            ...
                                            decoration: InputDecoration(
                                              labelText: "Amount",
                                              errorText: transactions[index]['amountError'].isNotEmpty
                                                  ? transactions[index]['amountError']
                                                  : null,
                                            ),
                                          ),
                                        ),
                                  ...
                                  if (index > 0)
                                    Padding(
                                      padding: const EdgeInsets.only(top: 40), // Add 40px top padding
                                      child: IconButton(
                                    ...
                                    const SizedBox(width: 48), // Invisible placeholder for first item
                                ],
                              ),
                            );
                          },
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            const SizedBox(width: 48),  // Invisible space to align with close button
                          ],
                        ),
                        const SizedBox(height: 30),
                      ],
                  ...
                  children: [
                    SizedBox(
                      ...
                      child: TextButton(
                        ...
                        onPressed: isSubmitEnabled ? submitTransactions : null,  // Enable/disable based on validation
                        child: const Center(
                          child: Text(
                            "SUBMIT",
                            style: TextStyle(
