...
class AccountState extends State<Account> {
  ...
  Widget build(BuildContext context) {
    ...
    return Human().address == null
        ? notSignedin()
        : !widget.org.memberAddresses.keys
                .contains(Human().address!.toLowerCase())
            ? notAMember()
            : accountWide(context);
  }
                        ...
                        builder: (context, snapshot) {
                          ...
                          if (snapshot.connectionState ==
                            ...
                            return Container(
                              ...
                              height: 50.0,
                              color:
                                  Theme.of(context).canvasColor, // Error color
                            );
                          }
                        },
                      ),
                    ...
                    children: [
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          Text(
                            widget.member!.personalBalance.toString(),
                            style: const TextStyle(
                                fontSize: 27, fontWeight: FontWeight.normal),
                          ),
                        ],
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          Text(
                            widget.member!.proposalsCreated.length.toString(),
                            style: const TextStyle(
                                fontSize: 27, fontWeight: FontWeight.normal),
                          ),
                        ],
